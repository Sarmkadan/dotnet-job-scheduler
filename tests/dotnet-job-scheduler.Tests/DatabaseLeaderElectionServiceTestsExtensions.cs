...
/// <summary>
/// Extension methods for <see cref="DatabaseLeaderElectionServiceTests"/> providing additional test scenarios
...
{
    /// <summary>
    /// Creates a new <see cref="DatabaseLeaderElectionService"/> instance with a fresh in-memory database context.
    /// </summary>
    ...
    /// <returns>A new <see cref="DatabaseLeaderElectionService"/> instance.</returns>
    ...
    /// <summary>
    /// Creates a pair of <see cref="DatabaseLeaderElectionService"/> instances sharing the same database context.
    ...
    /// <param name="leaseDurationSeconds">Lease duration in seconds. Defaults to 30.</param>
    /// <returns>A tuple containing both <see cref="DatabaseLeaderElectionService"/> instances.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="test"/> is null.</exception>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="test"/> or <paramref name="context"/> is null.</exception>
    ...
    /// <returns>A <see cref="DatabaseLeaderElectionService"/> with short lease duration.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="test"/> is null.</exception>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="test"/> or <paramref name="service"/> is null.</exception>
    /// <exception cref="ArgumentException"><paramref name="expectedInstanceId"/> is null or empty.</exception>
        ...
        string expectedInstanceId)
    {
        ...
        var context = service.GetContextForTesting();
