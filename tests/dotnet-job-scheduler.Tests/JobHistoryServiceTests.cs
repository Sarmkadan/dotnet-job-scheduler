...
/// <summary>
/// Contains unit tests for <see cref="JobHistoryService"/> that verify job history retrieval and summary functionality.
/// </summary>
public sealed class JobHistoryServiceTests
{
	...
	/// <summary>
	/// Creates a new instance of <see cref="JobHistoryService"/> with mocked dependencies for testing.
	/// </summary>
	/// <returns>A new <see cref="JobHistoryService"/> instance.</returns>
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobHistoryAsync(Guid)"/> returns paginated job execution history for a valid job.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobHistoryAsync(Guid, JobHistoryQuery)"/> filters job history by execution status.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobHistoryAsync(Guid)"/> throws <see cref="JobNotFoundException"/> when job does not exist.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobHistoryAsync(Guid, JobHistoryQuery)"/> returns correct pagination results.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobSummaryAsync(Guid)"/> returns accurate job execution statistics.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobSummaryAsync(Guid)"/> returns zero statistics when job has no executions.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryService.GetJobSummaryAsync(Guid)"/> throws <see cref="JobNotFoundException"/> when job does not exist.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="PagedResult{T}"/> properties are computed correctly for pagination metadata.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="JobHistoryQuery.Normalize"/> clamps page size to maximum allowed value.
	/// </summary>
	[Fact]
